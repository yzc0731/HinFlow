...
class Benchmark(abc.ABC):
    ...
    def _make_benchmark(self):
        ...
        if self.name == "libero_90" or self.name == "libero_test":
            self.tasks = tasks
        else:
    ...
    def get_task_id(self, task_name):
        return self.get_task_names().index(task_name)
    ...
    def get_task_from_name(self, task_name):
        return task_maps[self.name][task_name]

    def get_task_emb(self, i):
        return self.task_embs[i]

    def get_task_init_states(self, i, robot: str):
