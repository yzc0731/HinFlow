""" Borrow from original libero codebase: https://github.com/Lifelong-Robot-Learning/LIBERO/blob/master/benchmark_scripts/download_libero_datasets.py """
import argparse
import os

import libero.utils.download_utils as download_utils
